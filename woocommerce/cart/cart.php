    ...
    <div class="row">
        ...
        <div class="col-md-8">
        	...
        	<div class="woocommerce_cart_details">
                ...
                <h2 class="title"><?php esc_html_e('Cart','bazaar-lite');?> </h2>
						...
						foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
							...
							if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                                ...
                                <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                                    ...
                                    <td class="product-quantity" data-title="<?php esc_attr_e( 'Quantity', 'bazaar-lite' ); ?>">
                                    <?php
                            ...
                            <td colspan="6" class="actions">
                                ...
                                <?php if ( wc_coupons_enabled() ) { ?>
                                    ...
                                    <div class="coupon">
                                        ...
                                        <label for="coupon_code" class="screen-reader-text"><?php esc_html_e( 'Coupon:', 'bazaar-lite' ); ?></label>
                                        <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'bazaar-lite' ); ?>" />
                                        <button type="submit" class="button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'bazaar-lite' ); ?>"><?php esc_html_e( 'Apply coupon', 'bazaar-lite' ); ?></button>
